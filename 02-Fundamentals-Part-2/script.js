...
console.log(
  `${jonaObject.firstName} has ${jonaObject.friends.length} friends and his best friends is call ${jonaObject.friends[3]}`
);
...
const jonas = ['jonas', 'teacher', 19, 'hello', 224, 232];
//
const types = [];
